# BlutvAuthentication SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # BlutvAuthenticationSDK.new, not BlutvAuthenticationSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    BlutvAuthenticationSDK.new(opts)
  end
