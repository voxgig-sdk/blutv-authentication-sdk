...
class RegisterEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUTV_AUTHENTICATION_TEST_REGISTER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def register_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUTV_AUTHENTICATION_TEST_REGISTER_ENTID"]
