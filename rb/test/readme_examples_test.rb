...
#      offline in seeded test mode (BlutvAuthenticationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BlutvAuthentication_sdk.rb")
  SDK_CLASS = "BlutvAuthenticationSDK"
  ...
  SDK_BASE = "BlutvAuthentication_sdk"
