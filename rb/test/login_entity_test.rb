...
class LoginEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUTVAUTHENTICATION_TEST_LOGIN_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def login_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUTVAUTHENTICATION_TEST_LOGIN_ENTID"]
