...
class LoginEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID JSON to run live"
      return
    end
    client = setup[:client]
    ...
    assert !login_ref01_data["id"].nil?
...
def login_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID"]
