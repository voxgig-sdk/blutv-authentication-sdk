...
class SocialLoginEntity
  ...
  def make
    opts = @_entopts.dup
    SocialLoginEntity.new(@_client, opts)
  end
  ...
  # @return [SocialLogin, Hash] the current SocialLogin data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SocialLogin fields)
  def match_get
  ...
  #
  # @param reqdata [SocialLoginCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [SocialLogin, Hash] the created SocialLogin; raises BlutvAuthenticationError on failure
