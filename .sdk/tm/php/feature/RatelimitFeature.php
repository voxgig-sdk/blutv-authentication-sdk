...
// BlutvAuthentication SDK ratelimit feature
...
class BlutvAuthenticationRatelimitFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _acquire(BlutvAuthenticationContext $ctx): void
    {
    ...
    private function _track(BlutvAuthenticationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
