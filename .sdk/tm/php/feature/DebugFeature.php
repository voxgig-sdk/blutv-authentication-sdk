...
// BlutvAuthentication SDK debug feature
...
class BlutvAuthenticationDebugFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _finish(BlutvAuthenticationContext $ctx, bool $ok): void
    {
