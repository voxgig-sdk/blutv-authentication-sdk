...
// BlutvAuthentication SDK metrics feature
...
class BlutvAuthenticationMetricsFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _record(BlutvAuthenticationContext $ctx, bool $ok): void
    {
