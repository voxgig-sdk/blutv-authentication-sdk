...
// BlutvAuthentication SDK clienttrack feature
...
class BlutvAuthenticationClienttrackFeature extends BlutvAuthenticationBaseFeature
{
    ...
    public function PostConstruct(BlutvAuthenticationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BlutvAuthentication-SDK';
