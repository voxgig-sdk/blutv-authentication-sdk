...
// BlutvAuthentication SDK rbac feature
...
class BlutvAuthenticationRbacFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _required(BlutvAuthenticationContext $ctx): ?string
    {
    ...
    private function _reject(BlutvAuthenticationContext $ctx, string $required): void
    {
    ...
    private function _track(BlutvAuthenticationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
