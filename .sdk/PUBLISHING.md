...
|---|---|---|
| `ts/` | @voxgig-sdk/blutv-authentication-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/blutv-authentication-sdk \
      --repository voxgig-sdk/blutv-authentication-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/blutv-authentication-sdk` shows it, and
`npm trust revoke @voxgig-sdk/blutv-authentication-sdk --id=<id>` removes it.
