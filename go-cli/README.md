...
AQL-driven CLI and REPL for the BlutvAuthentication SDK. Positional arguments are
...
```sh
go build -o blutv-authentication-cli ./...
```
...
./blutv-authentication-cli list login
./blutv-authentication-cli load 1 login
./blutv-authentication-cli load '{id:1}' login
