...
func registerSDKWords(r *eng.Registry, client *sdk.BlutvAuthenticationSDK) {
...
func runOp(client *sdk.BlutvAuthenticationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
