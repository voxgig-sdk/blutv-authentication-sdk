...
func NewSocialLoginEntity(client *core.BlutvAuthenticationSDK, entopts map[string]any) *SocialLoginEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SocialLoginEntity) GetName() string { return e.name }
...
func (e *SocialLoginEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SocialLoginEntity) Deleted() bool {
	return e.deleted
}


func (e *SocialLoginEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSocialLoginEntity(e.client, opts)
}

func (e *SocialLoginEntity) Data(args ...any) any {
...
func (e *SocialLoginEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SocialLogin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SocialLoginEntity) DataTyped(data ...SocialLogin) SocialLogin {
	if len(data) > 0 {
		return typedFrom[SocialLogin](e.Data(asMap(data[0])))
	}
	return typedFrom[SocialLogin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SocialLogin (all fields
// optional at the wire level).
func (e *SocialLoginEntity) MatchTyped(match ...SocialLogin) SocialLogin {
	if len(match) > 0 {
		return typedFrom[SocialLogin](e.Match(asMap(match[0])))
	}
	return typedFrom[SocialLogin](e.Match())
}
...
func (e *SocialLoginEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SocialLoginEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SocialLoginEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *SocialLoginEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SocialLoginCreateData and returns an SocialLogin. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SocialLoginEntity) CreateTyped(reqdata SocialLoginCreateData, ctrl map[string]any) (SocialLogin, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return SocialLogin{}, err
	}
	return typedFrom[SocialLogin](res), nil
}



func (e *SocialLoginEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SocialLoginEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SocialLoginEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
