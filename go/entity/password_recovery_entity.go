...
type PasswordRecoveryEntity struct {
	name    string
	client  *core.BlutvAuthenticationSDK
...
func NewPasswordRecoveryEntity(client *core.BlutvAuthenticationSDK, entopts map[string]any) *PasswordRecoveryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PasswordRecoveryEntity) GetName() string { return e.name }
...
func (e *PasswordRecoveryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PasswordRecoveryEntity) Deleted() bool {
	return e.deleted
}


func (e *PasswordRecoveryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPasswordRecoveryEntity(e.client, opts)
}

func (e *PasswordRecoveryEntity) Data(args ...any) any {
...
func (e *PasswordRecoveryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PasswordRecovery; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PasswordRecoveryEntity) DataTyped(data ...PasswordRecovery) PasswordRecovery {
	if len(data) > 0 {
		return typedFrom[PasswordRecovery](e.Data(asMap(data[0])))
	}
	return typedFrom[PasswordRecovery](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PasswordRecovery (all fields
// optional at the wire level).
func (e *PasswordRecoveryEntity) MatchTyped(match ...PasswordRecovery) PasswordRecovery {
	if len(match) > 0 {
		return typedFrom[PasswordRecovery](e.Match(asMap(match[0])))
	}
	return typedFrom[PasswordRecovery](e.Match())
}
...
func (e *PasswordRecoveryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PasswordRecoveryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PasswordRecoveryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PasswordRecoveryEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PasswordRecoveryCreateData and returns an PasswordRecovery. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PasswordRecoveryEntity) CreateTyped(reqdata PasswordRecoveryCreateData, ctrl map[string]any) (PasswordRecovery, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PasswordRecovery{}, err
	}
	return typedFrom[PasswordRecovery](res), nil
}



func (e *PasswordRecoveryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PasswordRecoveryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PasswordRecoveryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
