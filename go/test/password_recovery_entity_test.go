...
func TestPasswordRecoveryEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		passwordRecoveryRef01Data = core.ToMapAny(entityData(passwordRecoveryRef01DataResult))
...
func password_recoveryBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BLUTV_AUTHENTICATION_TEST_PASSWORD_RECOVERY_ENTID")
