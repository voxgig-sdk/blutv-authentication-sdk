...
const testSeed = `map[string]any{"entity": map[string]any{"login": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "password_recovery": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "register": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "social_login": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
