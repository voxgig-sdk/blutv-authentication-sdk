...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/blutv-authentication` | `npm install @voxgig-sdk/blutv-authentication` |
| Python | `voxgig-sdk-blutv-authentication` | `pip install voxgig-sdk-blutv-authentication` |
| PHP | `voxgig-sdk/blutv-authentication` | `composer require voxgig-sdk/blutv-authentication` |
| Golang | `github.com/voxgig-sdk/blutv-authentication-sdk/go` | `go get github.com/voxgig-sdk/blutv-authentication-sdk/go` |
| Ruby | `voxgig-sdk-blutv-authentication` | `gem install voxgig-sdk-blutv-authentication` |
| Lua | `voxgig-sdk-blutv-authentication` | `luarocks install voxgig-sdk-blutv-authentication` |
