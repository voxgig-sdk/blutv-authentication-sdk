# BlutvAuthentication SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BlutvAuthenticationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BlutvAuthenticationSDK(...) and BlutvAuthenticationSDK.test(...) become
#      BlutvAuthenticationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "blutvauthentication_sdk"
_SDK_CLASS = "BlutvAuthenticationSDK"
