    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUTVAUTHENTICATION_TEST_SOCIAL_LOGIN_ENTID JSON to run live")
        client = setup["client"]
...
def _social_login_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "BLUTVAUTHENTICATION_TEST_SOCIAL_LOGIN_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUTVAUTHENTICATION_TEST_SOCIAL_LOGIN_ENTID"))
