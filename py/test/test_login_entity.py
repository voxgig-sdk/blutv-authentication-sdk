    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID JSON to run live")
        client = setup["client"]
        ...
        assert login_ref01_data["id"] is not None
...
def _login_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID"))
