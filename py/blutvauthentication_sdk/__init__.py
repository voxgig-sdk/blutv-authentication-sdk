...
from blutvauthentication_sdk.utility import register

# Load features
from blutvauthentication_sdk.feature.base_feature import BlutvAuthenticationBaseFeature
from blutvauthentication_sdk.features import _has_feature, _make_feature
...
class BlutvAuthenticationSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BlutvAuthenticationUtility()
    ...
    def get_utility(self):
        return BlutvAuthenticationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BlutvAuthenticationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Login(self, data=None) -> "LoginEntity":
        ...
        from blutvauthentication_sdk.entity.login_entity import LoginEntity
    ...
    def PasswordRecovery(self, data=None) -> "PasswordRecoveryEntity":
        ...
        from blutvauthentication_sdk.entity.password_recovery_entity import PasswordRecoveryEntity
    ...
    def Register(self, data=None) -> "RegisterEntity":
        ...
        from blutvauthentication_sdk.entity.register_entity import RegisterEntity
    ...
    def SocialLogin(self, data=None) -> "SocialLoginEntity":
        ...
        from blutvauthentication_sdk.entity.social_login_entity import SocialLoginEntity
