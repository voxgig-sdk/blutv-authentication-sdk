...
class SocialLoginEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SocialLoginEntity(self._client, opts)
    ...
    def match_get(self) -> SocialLogin:
    ...
    def create(self, reqdata: SocialLoginCreateData, ctrl=None) -> SocialLogin:
        utility = self._utility
