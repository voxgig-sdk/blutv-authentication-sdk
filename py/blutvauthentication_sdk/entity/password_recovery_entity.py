...
from blutvauthentication_sdk.blutvauthentication_types import (
    PasswordRecovery,
...
class PasswordRecoveryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PasswordRecoveryEntity(self._client, opts)
    ...
    def data_get(self) -> PasswordRecovery:
    ...
    def match_get(self) -> PasswordRecovery:
    ...
    def create(self, reqdata: PasswordRecoveryCreateData, ctrl=None) -> PasswordRecovery:
        utility = self._utility
