...
from blutvauthentication_sdk.core.helpers import get_ctx_prop, to_map
...
class BlutvAuthenticationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BlutvAuthenticationControl()
        ...
        if isinstance(sp, BlutvAuthenticationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BlutvAuthenticationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BlutvAuthenticationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BlutvAuthenticationOperation({})
    ...
    def make_error(self, code, msg):
        return BlutvAuthenticationError(code, msg, self)
