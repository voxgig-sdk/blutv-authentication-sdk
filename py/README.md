...
The Python SDK for the BlutvAuthentication API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.Login(None).create({"name": "Example"}, None)
...
result, err = client.BlutvAuthentication(None).load(
    {"id": "test01"}, None
)
