# BlutvAuthentication Python SDK



The Python SDK for the BlutvAuthentication API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Login()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/blutv-authentication-sdk/releases)) or
...
```
py/
├── blutvauthentication_sdk.py         -- Main SDK module
