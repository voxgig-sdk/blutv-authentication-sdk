...
function runner.env_override(m)
  local live = runner.getenv("BLUTV_AUTHENTICATION_TEST_LIVE")
  local override = runner.getenv("BLUTV_AUTHENTICATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BLUTV_AUTHENTICATION_TEST_EXPLAIN")
