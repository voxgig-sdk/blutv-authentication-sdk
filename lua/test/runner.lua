...
function runner.env_override(m)
  local live = runner.getenv("BLUTVAUTHENTICATION_TEST_LIVE")
  local override = runner.getenv("BLUTVAUTHENTICATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BLUTVAUTHENTICATION_TEST_EXPLAIN")
