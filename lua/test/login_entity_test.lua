...
describe("LoginEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID JSON to run live")
      return
    end
    ...
    assert.is_not_nil(login_ref01_data["id"])
...
function login_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID"])
