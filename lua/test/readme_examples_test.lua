...
local SDK_MODULE = "blutv-authentication_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["login"] = { ["test01"] = { id = "test01" } }, ["password_recovery"] = { ["test01"] = { id = "test01" } }, ["register"] = { ["test01"] = { id = "test01" } }, ["social_login"] = { ["test01"] = { id = "test01" } } } }'
