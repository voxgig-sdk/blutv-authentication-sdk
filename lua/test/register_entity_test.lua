...
describe("RegisterEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUTV_AUTHENTICATION_TEST_REGISTER_ENTID JSON to run live")
      return
    end
...
function register_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUTV_AUTHENTICATION_TEST_REGISTER_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["BLUTV_AUTHENTICATION_TEST_REGISTER_ENTID"])
