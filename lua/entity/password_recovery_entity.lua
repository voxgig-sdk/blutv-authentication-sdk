...
local PasswordRecoveryEntity = {}
PasswordRecoveryEntity.__index = PasswordRecoveryEntity


function PasswordRecoveryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PasswordRecoveryEntity)
  self._name = "password_recovery"
  self._client = client
...
function PasswordRecoveryEntity:get_name()
  return self._name
end


function PasswordRecoveryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PasswordRecoveryEntity.new(self._client, opts)
end
...
function PasswordRecoveryEntity:mark_deleted()
  self._deleted = true
end


function PasswordRecoveryEntity:deleted()
  return true == self._deleted
end


function PasswordRecoveryEntity:data_set(args)
  if args ~= nil then
...
function PasswordRecoveryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PasswordRecoveryEntity:match_set(args)
  if args ~= nil then
...
function PasswordRecoveryEntity:match_get()
...
function PasswordRecoveryEntity:stream(action, args, callopts)
...
function PasswordRecoveryEntity:_run_op(ctx, post_done)
  local utility = self._utility
