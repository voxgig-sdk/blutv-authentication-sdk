// Command BlutvAuthentication-mcp is an MCP server exposing the BlutvAuthentication
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BlutvAuthentication_list  — list records of an entity
//	BlutvAuthentication_load  — load a single record of an entity
//
