...
// BlutvAuthentication SDK SocialLogin entity
...
class SocialLoginEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SocialLoginEntity($this->_client, $opts);
    }

    /**
     * @param SocialLogin|array $args SocialLogin data (assoc-array) to store.
     */
    ...
    /**
     * @return SocialLogin|array The current SocialLogin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SocialLogin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SocialLogin fields).
     */
    ...
    /**
     * Create a new SocialLogin.
     *
     * @param SocialLoginCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SocialLoginCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SocialLogin|array The created SocialLogin as an assoc-array at the
