...
// BlutvAuthentication SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BlutvAuthenticationSDK::test)
...
{
    private const SDK_CLASS = 'BlutvAuthenticationSDK';
    ...
    private const SDK_BASE = 'blutvauthentication_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../blutvauthentication_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
