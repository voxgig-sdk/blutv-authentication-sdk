...
class LoginEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $this->assertNotNull($login_ref01_data["id"]);
...
function login_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BLUTV_AUTHENTICATION_TEST_LOGIN_ENTID");
