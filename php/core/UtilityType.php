...
// BlutvAuthentication SDK utility type

class BlutvAuthenticationUtility
{
    ...
    public static function copy(BlutvAuthenticationUtility $src): BlutvAuthenticationUtility
    {
        $u = new BlutvAuthenticationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
