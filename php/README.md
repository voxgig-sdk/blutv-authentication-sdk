# BlutvAuthentication PHP SDK

The PHP SDK for the BlutvAuthentication API. Provides an entity-oriented interface using PHP conventions.
...
```php
// Create
[$created, $_] = $client->Login(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->BlutvAuthentication(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── blutvauthentication_sdk.php          -- Main SDK class
...
The main class (`blutvauthentication_sdk.php`) exports the SDK class
