...
// BlutvAuthentication SDK utility: graphql
//
...
class BlutvAuthenticationGraphql
{
    ...
    // equivalent.
    public static function body(BlutvAuthenticationContext $ctx): mixed
    {
    ...
    public static function errors(BlutvAuthenticationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
