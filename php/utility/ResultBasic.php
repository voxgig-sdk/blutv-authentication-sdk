...
// BlutvAuthentication SDK utility: result_basic

class BlutvAuthenticationResultBasic
{
    public static function call(BlutvAuthenticationContext $ctx): ?BlutvAuthenticationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BlutvAuthenticationError) ? $result->err->msg : (string)$result->err;
