...
// BlutvAuthentication SDK utility: fetcher

class BlutvAuthenticationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BlutvAuthenticationSDK/1.0)';
    ...
    public static function call(BlutvAuthenticationContext $ctx, string $fullurl, array $fetchdef): array
    {
