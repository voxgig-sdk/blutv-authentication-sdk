...
// BlutvAuthentication SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BlutvAuthenticationMakeRequest
{
    public static function call(BlutvAuthenticationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BlutvAuthenticationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BlutvAuthenticationResponse($fetched);
        } else {
