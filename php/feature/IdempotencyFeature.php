...
// BlutvAuthentication SDK idempotency feature
...
class BlutvAuthenticationIdempotencyFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _mutating(BlutvAuthenticationContext $ctx): bool
    {
