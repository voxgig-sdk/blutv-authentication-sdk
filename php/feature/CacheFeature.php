...
// BlutvAuthentication SDK cache feature
...
class BlutvAuthenticationCacheFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _through(BlutvAuthenticationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
