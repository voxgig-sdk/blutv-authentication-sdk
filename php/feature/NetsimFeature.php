...
// BlutvAuthentication SDK netsim feature
...
class BlutvAuthenticationNetsimFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _simulate(BlutvAuthenticationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BlutvAuthenticationContext $ctx, array $applied): void
    {
        $client = $this->client;
