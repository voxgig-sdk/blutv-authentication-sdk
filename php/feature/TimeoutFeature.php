...
// BlutvAuthentication SDK timeout feature
...
class BlutvAuthenticationTimeoutFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _with_timeout(BlutvAuthenticationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BlutvAuthenticationContext $_ctx, float $ms): void
    {
        $client = $this->client;
