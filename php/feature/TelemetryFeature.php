...
// BlutvAuthentication SDK telemetry feature
...
class BlutvAuthenticationTelemetryFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _close(BlutvAuthenticationContext $ctx, bool $ok): void
    {
