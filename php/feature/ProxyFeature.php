...
// BlutvAuthentication SDK proxy feature
...
class BlutvAuthenticationProxyFeature extends BlutvAuthenticationBaseFeature
{
    ...
    public function init(BlutvAuthenticationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BlutvAuthenticationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
