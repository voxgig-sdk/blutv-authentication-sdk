...
// BlutvAuthentication SDK audit feature
...
class BlutvAuthenticationAuditFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _emit(BlutvAuthenticationContext $ctx, string $outcome): void
    {
