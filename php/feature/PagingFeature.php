...
// BlutvAuthentication SDK paging feature
...
class BlutvAuthenticationPagingFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _is_list(BlutvAuthenticationContext $ctx): bool
    {
