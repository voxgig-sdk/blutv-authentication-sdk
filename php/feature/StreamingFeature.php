...
// BlutvAuthentication SDK streaming feature
...
class BlutvAuthenticationStreamingFeature extends BlutvAuthenticationBaseFeature
{
    ...
    private function _iterate(BlutvAuthenticationResult $result): \Generator
    {
    ...
    private function _streamable(BlutvAuthenticationContext $ctx): bool
    {
