...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.BLUTVAUTHENTICATION_TEST_LIVE ||
    'TRUE' === process.env.BLUTVAUTHENTICATION_TEST_OVERRIDE
  ) {
  ...
  m.BLUTVAUTHENTICATION_TEST_EXPLAIN = process.env.BLUTVAUTHENTICATION_TEST_EXPLAIN || m.BLUTVAUTHENTICATION_TEST_EXPLAIN
