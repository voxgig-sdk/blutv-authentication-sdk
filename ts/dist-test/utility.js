...
function envOverride(m) {
    if ('TRUE' === process.env.BLUTV_AUTHENTICATION_TEST_LIVE ||
        'TRUE' === process.env.BLUTV_AUTHENTICATION_TEST_OVERRIDE) {
    ...
    m.BLUTV_AUTHENTICATION_TEST_EXPLAIN = process.env.BLUTV_AUTHENTICATION_TEST_EXPLAIN || m.BLUTV_AUTHENTICATION_TEST_EXPLAIN;
    return m;
}
